...
import { createPost, deletePost, getAllPosts, getMyPosts, getReferalPosts, toggleLike, updatePost,createComment, deleteComment, editComment, getAllCommentsByPost } from "../controllers/post.controller.js"
...
router.get("/comment/getCommentsByPost/:postId",authorization,getAllCommentsByPost)
