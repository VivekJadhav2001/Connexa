...
export default function AnalyticsSection() {
  ...
  const engagementData = [
    { day: 'Mon', engagement: totalUsers * 5, retention: activeUsers.length * 4, conversion: activeUsers.length },
    { day: 'Tue', engagement: totalUsers * 6, retention: activeUsers.length * 5, conversion: activeUsers.length + 2 },
    { day: 'Wed', engagement: totalUsers * 7, retention: activeUsers.length * 6, conversion: activeUsers.length + 4 },
    { day: 'Thu', engagement: totalUsers * 6, retention: activeUsers.length * 5, conversion: activeUsers.length + 1 },
    { day: 'Fri', engagement: totalUsers * 8, retention: activeUsers.length * 7, conversion: activeUsers.length + 6 },
    { day: 'Sat', engagement: totalUsers * 9, retention: activeUsers.length * 8, conversion: activeUsers.length + 8 },
    { day: 'Sun', engagement: totalUsers * 7, retention: activeUsers.length * 6, conversion: activeUsers.length + 3 },
  ]
